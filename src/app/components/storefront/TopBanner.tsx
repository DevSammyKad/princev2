    ...
    <div className="relative isolate flex items-center justify-center gap-x-6 overflow-hidden bg-gray-50 px-6 py-2.5 sm:px-3.5 ">
      ...
      <div className="flex justify-center items-center gap-x-4 gap-y-2">
        <p className="text-sm leading-6 text-gray-900 flex">
          <strong className="font-semibold flex items-center max-sm:hidden">
            Prince Glow Lights 2024
            <BadgePercent className="mx-3 text-blue-500" />
          </strong>
          Diwali Festival Offer | +91 9582430654
        </p>
      </div>
    </div>
  );
